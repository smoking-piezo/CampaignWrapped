...
def find_roll_date(log_lines): 
    ...
    roll_date = dt.datetime(year, month, day, hour, min, sec)
...
def init_generic_roll(log, roll_type):
    ...
    log.update_type(roll_type, log.log_lines)
...
def init_save_roll(log, roll_id_split):
    ...
    log.update_type(saving_throw_type, log.log_lines)
